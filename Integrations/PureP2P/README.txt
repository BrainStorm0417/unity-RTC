...
the WebRTC Video chat (https://assetstore.unity.com/packages/tools/network/webrtc-video-chat-68030) networking system. To use this
package you must have purchased and installed Dissonance and WebRTC Video Chat - **you will encounter build errors until you have done this**!

The included demo scene (Assets/Dissonance/Integrations/PureP2P/Demo/PureP2P Demo) demonstrates the basics of a voice
chat session running in a WebRTC network session. Consult the readme file in the demo folder for details on how to run
the demo and what features it demonstrates.
