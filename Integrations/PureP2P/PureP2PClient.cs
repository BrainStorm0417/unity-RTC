...
namespace Dissonance.Integrations.PureP2P
{
        ...
        : BaseClient<PureP2PServer, PureP2PClient, PureP2PPeer>
    {
        ...
        {
            _webrtcNetwork = UnityCallFactory.Instance.CreateBasicNetwork(
        ...
        {
            if (!_webrtcNetwork.SendData(connection, packet.Array, packet.Offset, packet.Count, reliable) && reliable)
                FatalError("Failed to send a reliable packet");
        }
